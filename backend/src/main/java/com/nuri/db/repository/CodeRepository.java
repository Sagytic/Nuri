...
//    List<MathGameCodeRes> findMathViewedByUserId(@Param("userId") Long userId);
    ...
    @Query(value = "SELECT * from mathgamecode where user_id = :userId and mathgamecode_id = :mathgamecodeId", nativeQuery = true)
    MathGameCode findByMathGameIdAndUserId(@Param("userId") Long userId, @Param("mathgamecodeId") Long mathgamcodeId);
